...
const FINAL_SURPRISE_TEXT = 'PAYLOAD DEPLOYED: HAPPY BIRTHDAY, OOH 🥳❤️ SEMOGA DI USIA YANG BARU INI, OOH SELALU DIBERI KESEHATAN, UMUR YANG PANJANG, REZEKI YANG LANCAR, DAN KEBAHAGIAAN YANG TIADA HABISNYA. SEMOGA SEMUA MIMPI DAN HARAPAN OOH BISA TERCAPAI SATU PER SATU, LANGKAHNYA SELALU DIMUDAHKAN, DAN SELALU DIKELILINGI ORANG-ORANG YANG BAIK SAMA OOH. NONIK SANGAT BERSYUKUR KARENA BISA JADI PASANGAN OOH, LIHAT SENYUM OOH, DAN IKUT MENEMANI SETIAP PROSES YANG OOH JALANI. SEMOGA HARI INI PENUH MOMEN INDAH DAN DOA BAIK YANG MENGALIR BUAT OOH. NONIK AKAN SELALU ADA BUAT OOH DI SETIAP SUKA, DUKA, DAN PERJALANAN PANJANG KITA KE DEPAN. I LOVE U SO MUCH, OOH 🥰 KLIK LINK UNTUK KLAIM HADIAH OOH: https://app.shopeepay.co.id/u/VUfPjpBkpzLfNyA1fZDSd?smtt=0.0.9';
